...
exports.processClaimDecisionServer = processClaimDecisionServer;
exports.validateHealthcareAccessServer = validateHealthcareAccessServer;
const policyService_1 = require("./policyService");
async function processClaimDecisionServer(db, payload) {
 ...
 */
async function validateHealthcareAccessServer(db, orgName) {
    if (!orgName)
        return { allowed: true };
    ...
    const evalResult = (0, policyService_1.evaluatePolicyServer)(policy);
