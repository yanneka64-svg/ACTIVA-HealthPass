...
export type FieldSchema =
  | { type: 'string'; required?: boolean; maxLength?: number; enum?: readonly string[] }
 ...
 */
export function validatePayload(data: any, schema: Schema, maxBytes: number = MAX_PAYLOAD_BYTES): void {
