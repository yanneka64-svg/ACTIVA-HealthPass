...
export const CeilingsView: React.FC<CeilingsViewProps> = ({
  ...
  const getBenefitBadgeStyle = (name: string) => {
    if (name.includes('Outpatient')) {
      return 'bg-blue-50 text-[#0a2e6b] border-blue-200';
    }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-900 via-[#0a2e6b] to-[#0a2e6b] rounded-3xl p-6 text-white shadow-xl border border-blue-800/60 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="px-4 py-3 rounded-2xl bg-white text-[#0a2e6b] hover:bg-blue-50 font-black text-xs transition flex items-center gap-2 shadow-lg cursor-pointer shrink-0"
            >
              <Settings className="w-4 h-4 text-[#0a2e6b]" />
        ...
        <div className="flex flex-wrap md:flex-nowrap gap-2.5 items-center flex-1">
          ...
          <div className="relative flex-1 min-w-[200px]">
            <input
              ...
              className="w-full pl-9 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#0a2e6b] focus:bg-white transition"
            />
          ...
          <select
            ...
            className="px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#0a2e6b]"
          >
          ...
          <div className="flex items-center gap-1.5">
            ...
            <select
              ...
              className="px-2.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#0a2e6b]"
            >
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
        ...
        <div className="px-6 py-4 bg-slate-50/70 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <div>
            <div className="flex items-center gap-2.5">
              <Sliders className="w-4 h-4 text-[#0a2e6b]" />
        ...
        {filteredCeilings.length === 0 ? (
          <div className="p-12 text-center text-slate-400 text-xs font-medium space-y-2">
            ...
            <button
              onClick={openNewBenefitLimitWizard}
              className="text-[#0a2e6b] font-bold hover:underline cursor-pointer"
            >
                    ...
                    <tr key={c.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="py-3.5 px-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <div className="w-6 h-6 rounded-lg bg-blue-50 text-[#0a2e6b] flex items-center justify-center font-bold text-[10px] shrink-0 border border-blue-100">
                      ...
                      <td className="py-3.5 px-4 whitespace-nowrap">
                        <div className="flex items-center gap-1.5">
                          <span className="px-2 py-0.5 rounded-md bg-blue-50 text-[#0a2e6b] border border-blue-100 text-[10px] font-bold" title={`Principal ≤ ${maxP} yrs`}>
                            P: ≤{maxP}y
                          </span>
      ...
      {ageLimitsModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-200">
          <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl border border-slate-200 overflow-hidden animate-in zoom-in-95">
            <div className="px-6 py-4.5 bg-gradient-to-r from-[#0a2e6b] to-[#0a2e6b] text-white flex items-center justify-between">
              <div className="flex items-center gap-2.5">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#0a2e6b]"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-2">
                <div className="p-3.5 bg-slate-50 rounded-2xl border border-slate-200">
                  <label className="block text-xs font-extrabold text-[#0a2e6b] mb-1">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-full px-3 py-1.5 bg-white border border-slate-200 rounded-xl text-sm font-black text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#0a2e6b]"
                    />
        ...
        <div className="fixed inset-0 z-50 flex justify-end bg-slate-900/50 backdrop-blur-xs transition-opacity animate-in fade-in duration-200">
          <div className="bg-white w-full max-w-xl h-full shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-right duration-200 border-l border-slate-200">
            ...
            <div className="p-6 border-b border-slate-200 flex items-center justify-between bg-white shrink-0">
              <div>
                <h3 className="text-base font-bold text-[#0a2e6b] tracking-tight">
            ...
            <div className="px-6 py-3 bg-slate-50 border-b border-slate-200 shrink-0">
              <div className="flex items-center justify-between text-xs font-bold">
                ...
                <div
                  className={`flex items-center gap-1.5 ${
                    wizardStep === 3 ? 'text-[#0a2e6b]' : 'text-slate-400'
                  }`}
                >
                  <span
                    className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-black ${
              ...
              {wizardStep === 1 && (
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full pl-9 pr-9 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#0a2e6b] focus:bg-white appearance-none cursor-pointer"
                      >
                        {availableOrgs.map((org) => (
                          <option key={org.id} value={org.name}>
                            {org.name} ({org.policyNumber})
                  ...
                  <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl space-y-3">
                    <div className="flex items-center gap-2">
                      <ShieldAlert className="w-4 h-4 text-[#0a2e6b]" />
                    ...
                    <div className="grid grid-cols-2 gap-3 pt-1">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-1.5 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#0a2e6b]"
                        />
                      </div>
                      <div>
                        <label className="block text-[11px] font-bold text-slate-700 mb-1">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="p-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-800 flex items-center gap-2">
                      <Building2 className="w-4 h-4 text-[#0a2e6b]" />
                      <span>{wizardOrg}</span>
                    </div>
                  </div>
                        ...
                        <button
                          ...
                          className={`px-3 py-1 rounded-lg transition cursor-pointer ${
                            activeLimitsTab === 'monthly'
                              ? 'bg-white text-[#0a2e6b] shadow-2xs'
                      ...
                      <table className="w-full text-left text-xs border-collapse">
                        <thead>
                          <tr className="bg-slate-50 border-b border-slate-200 text-[10px] font-extrabold text-slate-600 uppercase">
                            ...
                            <th className="py-2.5 px-2 text-center bg-blue-50/50 text-[#0a2e6b]">
                              Outpatient
                            </th>
                                    ...
                                    <div className="flex-1">
                                      ...
                                      <div className="relative">
                                        ...
                                        <input
                                          ...
                                          className="w-full pl-5 pr-2 py-1 bg-white border border-slate-200 rounded-lg text-xs font-bold text-slate-800 focus:outline-none focus:ring-1 focus:ring-[#0a2e6b]"
                                        />
                                      </div>
                                    </div>
                                    <div className="flex-1">
                    ...
                    <div className="pt-2 border-t border-slate-200">
                      ...
                      <div className="flex flex-wrap gap-1.5 mt-1.5">
                        {wizardSelectedBenefits.map((b) => (
                          <span
                            key={b}
                            className="px-2.5 py-1 rounded-lg bg-blue-50 text-[#0a2e6b] border border-blue-200 text-xs font-bold"
                          >
                            {b}
                          </span>
                        ))}
                          ...
                          >
                            ...
                            <div className="grid grid-cols-2 gap-2 text-[11px] text-slate-600">
                              <div className="p-2 bg-blue-50/50 rounded-lg">
                                <span className="font-bold text-[#0a2e6b] block">Outpatient</span>
              ...
              <div className="flex items-center gap-2">
                {wizardStep < 3 ? (
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-[#0a2e6b] hover:bg-[#072559] text-white text-xs font-bold transition flex items-center gap-1.5 cursor-pointer shadow-xs"
                  >
