      ...
      <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-xs flex flex-col sm:flex-row gap-3 items-center justify-between">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto justify-end flex-wrap">
          ...
          <button
            ...
            className="px-3 py-2 rounded-xl bg-blue-50 hover:bg-blue-100 text-[#0a2e6b] border border-blue-200 text-xs font-bold transition flex items-center gap-1.5 shadow-2xs cursor-pointer"
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
        <div className="px-6 py-4 bg-slate-50/70 border-b border-slate-200 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <History className="w-4 h-4 text-[#0a2e6b]" />
              ...
              <tbody className="divide-y divide-slate-100">
                {filteredLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="py-3.5 px-4 font-mono text-[#0a2e6b] font-semibold whitespace-nowrap">
                      {log.ipAddress}
                    </td>
